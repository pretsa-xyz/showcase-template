...
PrimeFaces Showcase Template is a JSF template based on the awesome [PrimeFaces Showcase](https://github.com/primefaces/primefaces-showcase).
...
public class MyAppMenu {
    ...
    public void init() {
        ...
        myPages.add(new MenuItem("Products", "/index", "5"));
...
<ui:repeat value="#{myAppMenu.menuCategories}" var="menuCategory">
...
```
#### 2. Create a template based on showcase-template
